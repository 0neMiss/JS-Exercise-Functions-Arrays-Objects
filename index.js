...
function getCarInfoByIndex(inventory, num) {
    ...
    const carinfoGet = inventory.find((item, index) => {
      index = num;
      return item;
    });
    return `This is a ${carinfoGet.car_make} ${carinfoGet.car_model}`;
}
...
function getCarInfoById(array, num) {
  var carget = array[num -1];

  return`This is a ${carget.car_make} ${carget.car_model}`;
}
